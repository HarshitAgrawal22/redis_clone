...
execute_command_graph = {
    cmds.COMMAND_SET_KEY: graph_protocols.execute_set_key_command,
    cmds.COMMAND_GET_KEY: graph_protocols.execute_get_key_command,
    cmds.COMMAND_BFS: graph_protocols.execute_breadth_first_search_command,
    cmds.COMMAND_DFS: graph_protocols.execute_depth_first_search_command,
    cmds.COMMAND_ADD_VERTEX: graph_protocols.execute_add_vertex_command,
    cmds.COMMAND_ADD_EDGE: graph_protocols.execute_add_edge_command,
    cmds.COMMAND_REMOVE_VERTEX: graph_protocols.execute_remove_vertex_by_value_command,
    cmds.COMMAND_REMOVE_EDGE: graph_protocols.execute_remove_edge_command,
    cmds.COMMAND_IS_WEIGHTED: graph_protocols.execute_is_weighted_command,
    cmds.COMMAND_IS_DIRECTED: graph_protocols.execute_is_directed_command,
    cmds.COMMAND_SHOW: graph_protocols.execute_display_command,
    cmds.COMMAND_GET_VERTEX_BY_VALUE: graph_protocols.execute_get_vertex_by_value_command,
    cmds.COMMAND_GET_VERTICES: graph_protocols.execute_get_vertices_command,
    cmds.COMMAND_GET_VERTEX_EDGE: graph_protocols.execute_get_edges_by_vertex_command,
    cmds.COMMAND_DIJKISTRA_DIST_DICT: graph_protocols.execute_dij_dist_dict_command,
    cmds.COMMAND_DIJKISTRA_PREV_DICT: graph_protocols.execute_dij_prev_dict_command,
    cmds.COMMAND_DIJKISTRA_SHORTEST_PATH: graph_protocols.execute_dij_shortest_path_command,
}
