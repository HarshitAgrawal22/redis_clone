...
execute_command_list = {
    cmds.COMMAND_LPULL: list_protocols.execute_lpull_command,
    cmds.COMMAND_LPUSH: list_protocols.execute_lpush_command,
    cmds.COMMAND_LRANGE: list_protocols.execute_lrange_command,
    cmds.COMMAND_RRANGE: list_protocols.execute_rrange_command,
    cmds.COMMAND_RPULL: list_protocols.execute_rpull_command,
    cmds.COMMAND_RPUSH: list_protocols.execute_rpush_command,
    cmds.COMMAND_SEARCH_INDEX: list_protocols.execute_search_index_command,
}
